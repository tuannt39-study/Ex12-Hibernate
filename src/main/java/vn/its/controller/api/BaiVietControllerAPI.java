...
@RestController
public class BaiVietControllerAPI {
	
	public static final Logger logger = LoggerFactory.getLogger(BaiVietControllerAPI.class);
	
	@Autowired
	private BaiVietService baiVietService;

	public BaiVietControllerAPI() {
		System.out.println("BaiVietControllerAPI()");
	}
